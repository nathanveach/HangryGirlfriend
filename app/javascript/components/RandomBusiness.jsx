...
const RandomBusiness = (props) => {
  let randomBusiness =
      props.businesses[Math.floor(Math.random() * props.businesses.length)],
    arr = [];
          ...
          <li className="media">
            <a href={restaurant.url}>
              <img
                ...
                className="custom-img img-thumbnail mx-1 mt-5"
              />
            </a>
            <div className="media-body ml-3">
              ...
              <div className="my-2">
                <a href={"tel:" + restaurant.phone} className="unstyled">
                  {restaurant.display_phone}
                </a>
                <br />
              </div>
              <a
                href={"https://maps.google.com/?q=" + restaurant.alias}
                className="unstyled"
              >
                ...
                <br />
                <small className="text-muted ml-2">
                  {(restaurant.distance * 0.000621371).toFixed(2)} miles away
                </small>
              </a>
            </div>
          </li>
